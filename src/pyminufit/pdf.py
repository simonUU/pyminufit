...
from .utils import ClassLoggingMixin, AttrDict
...
#        if name in self.parameters and isinstance(value, (int, float)):
#            self.parameters[name].value = value
#        else:
#            super().__setattr__(name, value)
    def add_parameter(self, param_var, param_name=None, final_name=None, **kwds):
        if final_name is None:
            assert param_name is not None, "Please provide a final name for the parameter"
